...
/** Retorna una referencia al elemento de mayor key sin removerlo del heap */
void* heap_peek(Heap *heap){
    return heap->array[0].content;
}

/** Retorna el key del elemento de mayor key */
int heap_peek_key(Heap *heap){
